#!/bin/bash
clear
#"This script is created by Vikas "
BIRed='\033[1;91m'        # Red
...
echo -e $BIYellow"######################################################################" $NORMAL
                               ...
                               ansible-playbook pre_valid_scrtry1.yml
                               clear
                else
                               clear
                               cd /etc/ansible/demo/prevalidation
...
echo -e $BIYellow"######################################################################" $NORMAL
        ...
        3)
                if [ $target  = "None" ] ; then
                        ...
                        ansible-playbook disk_alert1.yml
                        fi
                fi
                ;;
        4)
        ...
        5)
             ...
             echo -e $BIPurple" a. FTP Start \n "
                      ...
                      0)
                              ...
                              ;;
                      a)
                      ansible $target -m service -a "name=vsftpd state=started" --become
                              ;;
                      b)
                      ansible $target m service -a "name=nfs state=started" --become
                      ;; 
                      c)
                      ansible $target -m service -a "name=httpd state=started" --become
                      ;;
                      *)
                      echo -e "Wrong Choice !!!!"
                      read dummy
             ...
             echo -e $BIPurple" a. FTP Stop \n "
                      ...
                      0)
                           ...
                           ;;
                      a)
                      ansible $target -m service -a "name=vsftpd state=stopped" --become
                      ;;
                      b)
                      ansible $target -m service -a "name=nfs state=stopped" --become
                      ;;
                      c)
                      ansible $target -m service -a "name=httpd state=stopped" --become
                      ;;
                      *)
                      echo -e "Wrong Choice !!!!"
                      read dummy
             ...
             echo -e $BIPurple" a. Enabled FTP Service \n "
                      ...
                      0)
                           clear
                            ...
                            ;;
                      a)
                      ansible $target -m service -a "name=vsftpd enabled=yes" --become
                      ;;
                      b)
                      ansible $target -m service -a "name=nfs enabled=yes" --become
                      ;;
                      c)
                      ansible $target -m service -a "name=httpd enabled=yes" --become
                      ;;
                      *)
                      echo -e "Wrong Choice !!!!"
                      read dummy
             ...
             echo -e $BIPurple" a. Disabled FTP Service \n "
                      ...
                      0)
                            ...
                            ;;
                      a)
                      ansible $target -m service -a "name=vsftpd enabled=no" --become
                      ;;
                      b)
                      ansible $target -m service -a "name=nfs enabled=no" --become
                      ;;
                      c)
                      ansible $target -m service -a "name=httpd enabled=no" --become
                      ;;
                      *)
                      echo -e "Wrong Choice !!!!"
                      ready dummy
